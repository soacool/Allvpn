#!/bin/bash
#shadowsocks-libev obfs install by ABS
# ==========================================
# Color
RED='\033[0;31m'
NC='\033[0m'
...
cd /usr/bin
wget -O addss "https://${ss}/addss.sh"
wget -O delss "https://${ss}/delss.sh"
wget -O cekss "https://${ss}/cekss.sh"
wget -O renewss "https://${ss}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
