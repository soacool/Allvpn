...
wget -O /etc/accel-ppp.conf "https://${sstp}/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://${sstp}/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://${sstp}/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://${sstp}/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://${sstp}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
