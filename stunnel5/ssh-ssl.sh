...
trgo="raw.githubusercontent.com/ibed-berto/Allvpn/main/trojango"

# Link Hosting Kalian Untuk Stunnel5
stn="raw.githubusercontent.com/ibed-berto/Allvpn/main/stunnel5"
...
# install stunnel 5 
cd /root/
wget -q -O stunnel5.zip "https://${stn}/stunnel5.zip"
...
wget -q -O /etc/init.d/stunnel5 "https://${stn}/stunnel5.init"
