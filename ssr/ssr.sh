...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${ssr}/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://${ssr}/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://${ssr}/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://${ssr}/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://${ssr}/renewssr.sh && chmod +x /usr/bin/renewssr
